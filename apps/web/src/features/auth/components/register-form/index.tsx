...
const RegisterForm = () => {
  ...
  return (
    <ProcessMessage
      titleSuccess="Register in success"
      titleError="Register in error"
      successMessage={`Your account has been created. Welcome to ${envConfig.VITE_APP_NAME}.`}
      isLoading={registerMT.isPending}
      isSuccess={registerMT.isSuccess}
      error={registerMT.error}
    >
